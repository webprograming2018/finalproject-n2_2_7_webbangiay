<%-- 
    Document   : brand.jsp
    Created on : Dec 22, 2018, 3:13:42 PM
    Author     : diepv
--%>
    ...
    <body>
        <%
            ...
            if(request.getParameter("brand")!=null){
                ...
                if(brand.equals("AIR")) brand = "AIR JORDAN";
                product = productDAO.getListProductByBrand(brand);
            }
            else{
                product = productDAO.getListProduct();
            }
        ...
        <div class="container" style="margin-top: 30px;">
			<h3 class="h3" style="text-align: center;" ><%=brand%></h3>
                        <%for(int i=0;i<a;i++){%>
			<div class="row">  
