<%-- 
    Document   : color.jsp
    Created on : Dec 23, 2018, 5:04:39 PM
    Author     : diepv
--%>
    ...
    <body>
        <%
            ...
            if(request.getParameter("color")!=null){
                ...
                HashSet<Integer> list = productDAO.getListIdProductColor(color);
                for(Integer i : list){
        ...
        <div class="container" style="margin-top: 30px;">
			<h3 class="h3" style="text-align: center;text-transform: capitalize;" ><%=color%></h3>
                        <%for(int i=0;i<a;i++){%>
			<div class="row">  
